...
$departments = $DB->get_records_select('vloom_wp_departments', 'parent_id IS NULL OR parent_id = 0', null, 'name ASC', 'id,name');
foreach ($departments as $department) {
    $departmentoptions[$department->id] = format_string($department->name);
}
