...
$string['clientsecret_help'] = 'The client secret registered on the IdP. On some providers, it is also referred to as a key.';
...
$string['cfg_loginflow_rocreds_desc'] = '<b>This login flow is deprecated and will be removed from the plugin soon.</b><br/>Using this flow, the user enters their username and password into the Moodle login form like they would with a manual login. This will authorize the user with the IdP, but will not create a session on the IdP\'s site. Using the authorization request is recommended if you want users to be logged in to both Moodle and the IdP. Note that not all IdP support this flow. This option should only be used when other authorization grant types are not available.';
...
$string['cfg_signoffintegration_desc'] = 'If the option is enabled, when a Moodle user connected to the configured IdP logs out of Moodle, the integration will trigger a request at the logout endpoint below, attempting to log the user off from the IdP as well.';
...
$string['cfg_field_mapping_desc'] = 'User profile data can be mapped from the OpenID Connect IdP to Moodle. The remote fields available to map depend on the IdP and what claims are included in the ID token and access token.';

$string['cfg_cleanupoidctokens_key'] = 'Cleanup OpenID Connect Tokens';
$string['cfg_cleanupoidctokens_desc'] = 'If your users are experiencing problems logging in using OpenID Connect, try cleaning up OpenID Connect tokens. This removes stray and incomplete tokens that can cause errors. WARNING: This may interrupt logins in-process, so it\'s best to do this during downtime.';
...
$string['errorlogintoconnectedaccount'] = 'This OpenID Connect user is connected to a Moodle account, but OpenID Connect login is not enabled for this Moodle account. Please log in to the Moodle account using the account\'s defined authentication method.';
...
$string['privacy:metadata:auth_voidc_prevlogin'] = 'Previous login methods to undo OpenID Connect connections';
...
// "OpenID Connect", or the provider name configured by the administrator.
...
$string['ucp_o365accountconnected'] = 'This OpenID Connect account is already connected with another Moodle account.';
...
$string['errorusermatched'] = 'The OpenID Connect account "{$a->userupn}" is already matched with Moodle user "{$a->username}". To complete the connection, please log in as that Moodle user first.';
...
<li>Backup Moodle database, in particular <span class="code">user</span> and <span class="code">auth_voidc_tokens</span> tables.</li>
<li>Use the <a href="{$a}" target="_blank">update binding username tool</a> to update Moodle username and auth_voidc token records of the existing user to match the value of the claim to be changed to.</li>
...
$string['binding_username_claim_help_ms_no_user_sync'] = 'The available binding username claim options include:
<ul>
<li><b>Choose automatically</b>: Uses current logic, falling back to <b>sub</b> if no claim is found.</li>
<li><b>preferred_username</b>: Common claim for many IdPs. <span class="not_support_user_sync">Does not support user sync.</span></li>
<li><b>email</b>: Email address claim.</li>
<li><b>sub</b>: Subject identifier. <span class="not_support_user_sync">Does not support user sync.</span></li>
...
$string['binding_username_claim_help_ms_with_user_sync'] = 'The available binding username claim options include:
<ul>
<li><b>Choose automatically</b>: Uses current logic, falling back to <b>sub</b> if no claim is found.</li>
<li><b>email</b>: Email address claim.</li>
...
$string['binding_username_claim_help_non_ms'] = 'The available binding username claim options include:
<ul>
<li><b>Choose automatically</b>: Uses current logic, falling back to <b>sub</b> if no claim is found.</li>
...
$string['update_success_o365'] = 'Connection record updated successfully.';
...
<p>The example file below would change the binding username claim from <span class="code">email</span> to <span class="code">sub</span>.</p>';
...
// Client management (multi-IdP).
$string['client_list_heading'] = 'Identity providers';
$string['client_list_intro'] = 'Manage the OpenID Connect identity providers that users can sign in with. Each enabled provider appears as a button on the Moodle login page.';
$string['client_list_empty'] = 'No identity providers configured yet. Click "Add identity provider" to create one.';
$string['client_add'] = 'Add identity provider';
$string['client_add_heading'] = 'Add identity provider';
$string['client_edit_heading'] = 'Edit identity provider: {$a}';
$string['client_col_name'] = 'Name';
$string['client_col_clientid'] = 'Client ID';
$string['client_col_authendpoint'] = 'Authorization endpoint';
$string['client_col_status'] = 'Status';
$string['client_col_actions'] = 'Actions';
$string['client_status_enabled'] = 'Enabled';
$string['client_status_disabled'] = 'Disabled';
$string['client_field_name'] = 'Display name';
$string['client_field_name_help'] = 'The label shown on the Moodle login page for this provider.';
$string['client_field_department'] = 'Department';
$string['client_field_department_help'] = 'Select the department this identity provider belongs to.';
$string['client_field_group'] = 'Default permission group';
$string['client_field_group_help'] = 'Select the default permission group to assign to new users created via this identity provider.';
$string['client_field_icon'] = 'Login button icon';
$string['client_field_icon_help'] = 'Upload an image (PNG, JPG, SVG, GIF) shown next to this provider on the login page. Recommended size 32×32. Leave empty to use a default icon.';
$string['client_not_found'] = 'Identity provider not found.';
$string['client_created'] = 'Identity provider "{$a}" was created.';
$string['client_updated'] = 'Identity provider "{$a}" was updated.';
$string['client_deleted'] = 'Identity provider "{$a}" was deleted.';
$string['client_enabled'] = 'Identity provider "{$a}" is now enabled.';
$string['client_disabled'] = 'Identity provider "{$a}" is now disabled.';
$string['client_delete_confirm'] = 'Are you sure you want to delete the identity provider "{$a}"? This cannot be undone.';
$string['errornoclientrecord'] = 'No OpenID Connect identity provider was selected or the selected provider no longer exists.';
$string['errorunknownclient'] = 'The selected identity provider is invalid or has been disabled.';
$string['settings_section_display'] = 'Display';
